...
// ORES
removeOre(<nuclearcraft:ore:0>, <ore:oreCopper>);
removeOre(<nuclearcraft:ore:1>, <ore:oreTin>);
removeOre(<nuclearcraft:ore:2>, <ore:oreLead>);
removeOre(<nuclearcraft:ore:3>, <ore:oreUranium>);
